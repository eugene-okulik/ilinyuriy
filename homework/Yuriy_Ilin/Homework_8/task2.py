...
print(val_200)
print(val_1000)
print(val_100000)  # На данном числе падает ошибка, т.к. слишком большое значение. Решил это не исправлять, т.к. на данном этапе уйду в дебри, если надо, то могу попробовать изучить вопрос и решить задачу
